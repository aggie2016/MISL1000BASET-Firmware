...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mthumb ${CPU} ${FPU} -std=gnu99 -Os -ffunction-sections -fdata-sections -MD -Wall")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mthumb ${CPU} ${FPU}  -Os -ffunction-sections -fdata-sections -MD -Wall -fno-exceptions -fno-rtti")

set(CMAKE_SHARED_LIBRARY_LINK_C_FLAGS "")
set(CMAKE_SHARED_LIBRARY_LINK_CXX_FLAGS "")
set(CMAKE_EXE_LINKER_FLAGS "-T${PROJECT_SOURCE_DIR}/tm4c1294.ld -specs=${PROJECT_SOURCE_DIR}/tiva.specs --specs=nano.specs --specs=nosys.specs")

# Processor specific definitions
add_definitions(-DDEBUG)
add_definitions(-DDEBUG_DEFAULT_INTERRUPT_HANDLERS)
add_definitions(-DARM_MATH_CM4)
add_definitions(-DPART_TM4C1294NCPDT)
add_definitions(-DTARGET_IS_TM4C129_RA0)
add_definitions(-Dgcc)
add_definitions(-DTM4C1294NCPDT)
